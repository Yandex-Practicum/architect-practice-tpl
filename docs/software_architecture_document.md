...
- [[#Краткий обзор|Краткий обзор]]
		- [[#Название проекта: ПЛАТФОРМА ОНЛАЙН-РИТЕЙЛА NEXTGEN|Название проекта: ПЛАТФОРМА ОНЛАЙН-РИТЕЙЛА NEXTGEN]]
		- [[#Цель|Цель]]
		- [[#КЛЮЧЕВЫЕ ОСОБЕННОСТИ|КЛЮЧЕВЫЕ ОСОБЕННОСТИ]]
- [[#Введение|Введение]]
- [[#Ключевые термины, определения, аббревиатуры|Ключевые термины, определения, аббревиатуры]]
- [[#Границы проекта|Границы проекта]]
		- [[#Включено:|Включено:]]
		- [[#Исключено:|Исключено:]]
- [[#Требования|Требования]]
	- [[#Требования#Заинтересованные стороны|Заинтересованные стороны]]
	- [[#Требования#Функциональные требования|Функциональные требования]]
	- [[#Требования#Нефункциональные требования|Нефункциональные требования]]
	- [[#Требования#Ограничения|Ограничения]]
	- [[#Требования#Предположения|Предположения]]
- [[#Текущая архитектура|Текущая архитектура]]
- [[#Целевая архитектура|Целевая архитектура]]
		- [[#Предположения#Обзор|Обзор]]
		- [[#Предположения#Функциональное Представление|Функциональное Представление]]
		- [[#Предположения#Развертывание|Развертывание]]
		- [[#Предположения#Процессы|Процессы]]
		- [[#Предположения#Данные|Данные]]
		- [[#Предположения#Безопасность|Безопасность]]
		- [[#Предположения#Производительность|Производительность]]
		- [[#Предположения#Сетевое взаимодействие|Сетевое взаимодействие]]
- [[#Альтернативные варианты|Альтернативные варианты]]
		- [[#Предположения#1. Развертывание на собственных серверах|1. Развертывание на собственных серверах]]
		- [[#Предположения#2. Гибридное облачное решение|2. Гибридное облачное решение]]
		- [[#Предположения#Критерии оценки|Критерии оценки]]
		- [[#Предположения#Итог|Итог]]
- [[#Риски|Риски]]
- [[#Бюджет и дорожная карта|Бюджет и дорожная карта]]
	- [[#Бюджет и дорожная карта#Дорожная карта|Дорожная карта]]
	- [[#Бюджет и дорожная карта#Планирование ресурсов|Планирование ресурсов]]
