...
|Технические ограничения| C-004 |Целевая нагрузка на систему N < 100 RPS||Заказчик|||17 человек на первом этапе, ну пусть 100 на этапе расширения на всё офисное здание (узнать +- количество сотрудников всех офисов???)|
|Границы проекта| C-005 |Выделение парковочных мест для офиса производится вручную офис-менеджером |Операционные команды/Команды поддержки |Заказчик ||||
|Границы проекта| C-006 |Генерация схемы парковки с доступными для бронирования конкретным офисом местами выполняется вручную офис-менеджером |Операционные команды/Команды поддержки |Заказчик||||
|Границы проекта| C-007 |Проект должен учитывать возможность расширения при выборе используемого стека разработки |Операционные команды/Команды поддержки |Заказчик||||
|Юридические и регуляторные| С-008 |Система не должна хранить/обрабатывать персональные данные сотрудников |Операционные команды/Команды поддержки |Заказчик | |152-ФЗ ||
|Границы проекта| С-009 | Система должна работать круглосуточно, доступность - 98% |Операционные команды/Команды поддержки |Заказчик||| Выход из строя системы не приведёт к высоким финансовым потерям |
...
| - | - | Автоматическая повторяющаяся отправка электронного письма на заданный адрес. Письмо содержит список регистрационных номеров автомобилей из списка бронирований на следующие сутки | Обязательно |  Партнеры третьих сторон | Охрана парковки | Новый ||
| - | - | - | - | - | - | - | - |
|Бронирование парковки||Бронирование конкретного места|||Сотрудник|Новый||
|Бронирование парковки||Отмена бронирования|||Сотрудник|Новый||
|Бронирование парковки||Администрирование|||Офис-менеджер|Новый||
|Бронирование парковки||Уведомление о бронировании сотруднику|||Сотрудник|Новый||
|Бронирование парковки||Уведомление о бронированиях на день для охранников вечером предыдущего дня|||Охрана парковки|Новый||
|Бронирование парковки||Парковкой пользуются 17 человек. Возможность расширения после возвращения сотрудников в офис с удаленки|||Заказчик|Новый||
|Бронирование парковки||Внесение пользователей системы вручную или с использованием системы авторизации|||Заказчик|Новый||
|Бронирование парковки||Уведомление о бронировании сотруднику||||Новый||
|Бронирование парковки||Настраиваемый лимит бронирований|||Заказчик|Новый||
|Бронирование парковки||Списывание дня с баланса при отмене брони в день записи|||Заказчик|Новый||
|Бронирование парковки||Отображение баланса для пользователя|||Заказчик|Новый||
|Бронирование парковки||Схема парковки|||Заказчик|Новый||
|Бронирование парковки||Интерфейс пользователя|||Заказчик|Новый||
|Бронирование парковки||Схема парковки|||Заказчик|Новый||
...
|---|---|---|---|---|---|---|---|
|Масштабируемость||Система должна иметь возможность расширения для возможности обслуживания всех арендаторов здания||Партнеры третьих сторон|Владельцы офиса|Новый||
|Интеграция||Система должна иметь возможность интеграции с внешней системой авторизации|||Заказчик|Новый||
|Удобство использования||Интерфейс пользователя должен быть реализован в виде ультратонкого клиента (веб-приложения)|||Заказчик|Новый||
|Доступность||Система должна работать круглосуточно|||Заказчик|Новый||
