...
|---|---|---|---|---|---|---|
|Сроки||Проект должен быть реализован за 4 недели.|Операционные команды/Команды поддержки|Заказчик||||
...
| - | - | - | - | - | - | - | - |
|Бронирование парковки||Бронирование конкретного места||Сотрудник||||
|Бронирование парковки||Отмена бронирования||Сотрудник||||
|Бронирование парковки||Администрирование||Офис-менеджер||||
|Бронирование парковки||Уведомление о бронировании сотруднику||Сотрудник||||
|Бронирование парковки||Уведомление о бронированиях на день для охранников вечером предыдущего дня||Охрана парковки||||
|Бронирование парковки||Парковкой пользуются 17 человек. Возможность расширения после возвращения сотрудников в офис с удаленки||Заказчик||||
|Бронирование парковки||Внесение пользователей системы вручную или с использованием системы авторизации||||||
|Бронирование парковки||Уведомление о бронировании сотруднику||||||
|Бронирование парковки||Настраиваемый лимит бронирований||||||
|Бронирование парковки||Списывание дня с баланса при отмене брони в день записи||||||
|Бронирование парковки||Отображение баланса для пользователя||||||
|Бронирование парковки||Схема парковки||||||
...
|---|---|---|---|---|---|---|---|
|Масштабируемость||Система должна иметь возможность расширения для возможности обслуживания всех арендаторов здания||||Партнеры третьих сторон|Владелец офисного здания|
