...
|---|---|---|---|---|---|---|
|Сроки||Проект должен быть реализован за 4 недели. |Операционные команды/Команды поддержки |Заказчик |Новый|||
|Ресурсы||Расход ресурсов на реализацию проекта должен быть не более 20 человеко-часов |Операционные команды/Команды поддержки |Заказчик||||
|Границы проекта||Результатом проекта пользуются сотрудники Заказчика (не более 25 человек)|Операционные команды/Команды поддержки |Заказчик|||Предусмотреть расширение проекта |
|Технические ограничения||Целевая нагрузка на систему N < 100 RPS||Заказчик|||17 человек на первом этапе, ну пусть 100 на этапе расширения на всё офисное здание (узнать +- количество сотрудников всех офисов???)|
|Границы проекта||Выделение парковочных мест для офиса производится вручную офис-менеджером |Операционные команды/Команды поддержки |Заказчик ||||
|Границы проекта||Генерация схемы парковки с доступными для бронирования конкретным офисом местами выполняется вручную офис-менеджером |Операционные команды/Команды поддержки |Заказчик||||
|Границы проекта||Проект должен учитывать возможность расширения при выборе используемого стека разработки |Операционные команды/Команды поддержки |Заказчик||||
|Юридические и регуляторные||Система не должна хранить/обрабатывать персональные данные сотрудников |Операционные команды/Команды поддержки |Заказчик | |152-ФЗ ||
...
| - | - | - | - | - | - | - | - |
| - | - | доступ по логину (добавляется офис-менеджером в систему) | Обязательно | Конечные пользователи | Сотрудник | Новый ||
...
|Безопасность||Система должна иметь возможность верификации пользователей|||Заказчик|Новый||
