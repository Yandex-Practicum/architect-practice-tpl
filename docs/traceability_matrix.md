...
| 26.09.2023| Андрей Маркушин | Заполнение матрицы данными по результатам встречи с Заказчиком| 
...
|Границы проекта||Результатом проекта пользуются сотрудники Заказчика|Операционные команды/Команды поддержки|Заказчик|||Предусмотреть расширение проекта |
