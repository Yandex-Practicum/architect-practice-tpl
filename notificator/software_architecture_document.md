...
| 13.10.2023 | Евгений Климов | Актуализация полной диаграммы последовательности |
...
***Хранилище настроек:*** Отвечает за хранение настроек пользователей, таких как контактные данные и предпочтения по типам оповещений. Очередь обращается к нему для получения необходимых данных.

***Очереди для обработки больших объемов:*** Этот компонент обеспечивает управление и обработку больших объемов оповещений. Он также гарантирует сохранность и доставку оповещений, даже в случае временных сбоев в системе.
