...
| 17.10.2023 | Евгений Климов | Поправил Обзор под ADR-021                       |
...
* С выбором технологий, можно ознакомиться в [ADR-021 Выбор технологии для отправки оповещений](adrs/adr_021.md).
...
sequenceDiagram
    ...
    box Api
        participant MailAPI as "Внешнее API рассылки email"
    ...
    loop Обработка сообщений
        ...
        par Отпрака email
            ...
            Security ->>+ MailAPI: Запрос отправки по email
            MailAPI -->>- Security: Подтверждение отправки
